--------------------------------------------------------
--  DDL for Trigger TR#STORE#WARD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "FCR"."TR#STORE#WARD" 
 ...
 after statement is
 begin
  P#TR_UTILS.DO#WARD_CLOSE(ATAB#A_W_MN, case when INSERTING then 'I' else 'D' end, 'STORE');
 end after statement;
end;
/
ALTER TRIGGER "FCR"."TR#STORE#WARD" ENABLE;
