...
FUNCTION INS#LOG(
                P_DATE in T#LOG.C#DATE%type, 
                P_ADR in T#LOG.C#ADR%type, 
                P_LS in T#LOG.C#LS%type,  
                P_OWNER in T#LOG.C#OWNER%type,  
                P_TYPE_READ in T#LOG.C#TYPE_READ%type,  
                P_ID_SOURSE in T#LOG.C#ID_SOURSE%type,  
                P_NOTE in T#LOG.C#NOTE%type, 
                P_AUTHOR in T#LOG.C#AUTHOR%type,
                P_TP_FLAG in T#LOG.C#TP_FLAG%type,
                P_OLD_RECORD in T#LOG.C#OLD_RECORD%type,
                P_NEW_RECORD in T#LOG.C#NEW_RECORD%type
                ) 
                RETURN NUMBER;
