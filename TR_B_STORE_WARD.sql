--------------------------------------------------------
--  DDL for Trigger TR#B_STORE#WARD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "FCR"."TR#B_STORE#WARD" 
 ...
 after statement is
 begin
  P#TR_UTILS.DO#WARD_B_CLOSE(ATAB#H_S_MN, case when INSERTING then 'I' else 'D' end, 'B_STORE');
 end after statement;
end;
/
ALTER TRIGGER "FCR"."TR#B_STORE#WARD" ENABLE;
