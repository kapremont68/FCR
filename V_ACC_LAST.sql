--------------------------------------------------------
--  DDL for View V#ACC_LAST
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "FCR"."V#ACC_LAST" ("C#ACCOUNT_ID", "C#HOUSE_ID", "C#FLAT_NUM", "C#HOUSE_NUM", "C#ROOMS_ID", "C#ROOMS_PN", "C#ACC_DATE", "C#ACC_NUM", "C#SN", "C#VD_VN", "C#VD_SIGN_DATE", "C#VD_SIGN_S_ID", "C#SPEC_DATE", "C#SPEC_VN", "C#SPEC_SIGN_DATE", "C#SPEC_SIGN_S_ID", "C#PERSON_ID", "C#PART_COEF", "C#OP_DATE", "C#OUT_PROC_ID", "C#OUT_NUM", "C#RKC_CODE", "C#RKC_NAME") AS 
  with
  vd as(
    SELECT *
